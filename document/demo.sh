...
HOSTNAME="192.168.169.85"    #数据库信息
PORT="3306"
USERNAME="root"
PASSWORD="123456"

DBNAME="springboot"         #数据库名称
TABLENAME="t_etl_job_logs"
home="ids测试环境ids任务发生异常,请注意"
home_1="ids测试环境ids任务无异常."
#https://oapi.dingtalk.com/robot/send?access_token=1390ceb380a86ddec12c1daf27be8fe9781be00cc4f21fe9559c7f5c12949a37
