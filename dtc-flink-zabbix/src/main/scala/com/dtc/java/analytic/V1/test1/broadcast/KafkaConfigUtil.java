...
public class KafkaConfigUtil {
    ...
    public static Properties buildKafkaProps(ParameterTool parameterTool) {
        ...
        props.put("bootstrap.servers", parameterTool.get(PropertiesConstants.KAFKA_BROKERS, com.dtc.java.analytic.V1.common.constant.PropertiesConstants.DEFAULT_KAFKA_BROKERS));
        props.put("zookeeper.connect", parameterTool.get(PropertiesConstants.KAFKA_ZOOKEEPER_CONNECT, com.dtc.java.analytic.V1.common.constant.PropertiesConstants.DEFAULT_KAFKA_ZOOKEEPER_CONNECT));
        props.put("group.id", parameterTool.get(PropertiesConstants.KAFKA_GROUP_ID, com.dtc.java.analytic.V1.common.constant.PropertiesConstants.DEFAULT_KAFKA_GROUP_ID));
