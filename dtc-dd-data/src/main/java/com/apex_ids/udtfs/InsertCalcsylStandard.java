...
import com.apex_ids.util.MyEnum.CustCalsylInStandard;
 ...
 */
public class InsertCalcsylStandard extends GenericUDTF {
    ...
    private List<Object> cost(List<List<Object>> bills){
        ...
        for(List<Object> l:bills){
            ...
            sb.append(new BigDecimal(l.get(1)+"")+","+new BigDecimal(l.get(2)+"")+","+
                    new BigDecimal(l.get(3)+"")+","+l.get(4)+","+new BigDecimal(l.get(5)+"")+","+new BigDecimal(l.get(6)+"")+
                    ","+new BigDecimal(l.get(7)+"")+","+new BigDecimal(l.get(8)+"")+","+new BigDecimal(l.get(9)+"")+","+new BigDecimal(l.get(10)+"")
                    +","+new BigDecimal(l.get(11)+"")+";");
            /*sb.append(new BigDecimal(l.get(1)+"")+","+new BigDecimal(l.get(2)+"")+","+
    ...
    private List<Object> tranDataType(List<String> bill){
        ...
        for (int i=0; i<bill.size(); i++){
            result.add(UdfUtil.parseObject(bill.get(i), CustCalsylInStandard.values()[i].getType()));
        }
        return result;
    }
        ...
        Collections.sort(bills,
                new Comparator<List<Object>>() {
                    ...
                    public int compare(List<Object> d1, List<Object> d2) {
                        Integer d1Str = Integer.valueOf(d1.get(CustCalsylInStandard.rq.getIndex()).toString());
                        Integer d2Str = Integer.valueOf(d2.get(CustCalsylInStandard.rq.getIndex()).toString());
